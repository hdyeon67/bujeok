  ...
  return (
    <main className="mx-auto w-full max-w-md px-5 py-8">
      ...
      <section className="space-y-5 text-[15px] leading-relaxed text-meok-soft">
        <p>
          <b className="text-meok">행운부적</b>은 이름과 생년월일, 그리고 담고 싶은
          소원을 입력하면 사주의 오행(목·화·토·금·수) 분포를 분석해 가장{" "}
          <b className="text-jusa">부족한 기운</b>을 찾아, 그 기운을 채워 주는
          &lsquo;나만의 부적 카드&rsquo;를 만들어 드리는 서비스예요.
        </p>
        <p>
          같은 입력에는 항상 같은 부적이 나오도록 설계했고, 매일 바뀌는{" "}
          <b className="text-meok">오늘의 행운 한 줄</b>도 함께 담았어요. 실시간
          인공지능 호출 없이 미리 정해진 규칙과 문구로 만들어져 언제나 빠르게
          완성돼요.
        </p>

        <div className="rounded-2xl border border-hanji-deep/60 bg-hanji-soft/50 p-5">
          <h2 className="mb-2 text-base font-semibold text-meok">
            재미·참고용 안내
          </h2>
          <p className="text-sm">
        ...
        <div className="rounded-2xl border border-hanji-deep/60 bg-hanji-soft/50 p-5">
          ...
          <p className="text-sm">
            ...
            없어요. 자세한 내용은{" "}
            <Link href="/privacy" className="text-jusa underline underline-offset-2">
              개인정보처리방침
            </Link>
            에서 확인할 수 있어요.
          </p>
        ...
        <p className="pt-2 text-center text-sm text-meok-faint">
